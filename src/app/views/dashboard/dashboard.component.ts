...
import type { MovementDto, ProductDto, WarehouseDto, UserDto } from '../../models/api';
...
export class DashboardComponent implements OnInit {
  ...
  async loadDashboardData() {
    ...
    try {
      ...
      this.errorMessage.set(e?.response?.data?.message || e?.message || 'Error loading dashboard metrics.');
    } finally {
