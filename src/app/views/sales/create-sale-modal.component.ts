...
import type { ProductDto, CustomerDto, CashRegisterDto } from '../../models/api';
      ...
      <div class="custom-modal-backdrop" (click)="close()">
        <div class="custom-modal-content modal-lg" (click)="$event.stopPropagation()">
          <div class="custom-modal-header">
            <h5 class="fw-bold">Register New POS Sale</h5>
            ...
            <form cForm [formGroup]="saleForm">
              <c-row>
                <c-col md="6" class="mb-3">
                  <label class="small fw-semibold text-secondary mb-1">Customer</label>
                  <select cSelect formControlName="customerId">
                    <option value="">General Public (No customer)</option>
              ...
              <div class="mb-4 mt-2">
                <div class="d-flex justify-content-between align-items-center mb-2">
                  <h6 class="fw-bold text-dark mb-0">Sale Items</h6>
                ...
                <div class="border rounded bg-light p-2">
                  @if (items.length === 0) {
                    <div class="text-center py-3 text-secondary small">No items added yet. Click "Add Item" row.</div>
                  } @else {
              ...
              <c-row class="border-top pt-3 mt-3 align-items-center">
                <c-col md="6">
                  <label class="small fw-semibold text-secondary mb-1">Received Payment Amount *</label>
                  <input type="number" formControlName="paidAmount" cFormControl />
                </c-col>
                <c-col md="6" class="text-end">
                  <div class="text-secondary small">Total Invoice Amount</div>
